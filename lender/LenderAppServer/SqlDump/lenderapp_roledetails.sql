...
INSERT INTO `roledetails` VALUES ('Sales Manager',NULL,'test','1kUmiMMNKw'),('Sales Exec',NULL,'test','cndUaXwtxW'),('Sales Exec',NULL,'test','6sTmSB5pZj'),('Sales Exec',NULL,'test','8UyLRERPxH');
